			...
			<form method="POST" >
				<div class="row">
					...
					<div class="col-sm">
						...
						<input type="email" id="inputEmailAddress" name="email" class="form-control" placeholder="Email Address" required>
					</div>
					<div class="col-12">
					    <label for="inputStreetAddress" class="">StreetAddress</label>
					...
					<div class="col-sm">
					    ...
					    <input type="number" id="inputAge" name="DateOfBirth" class="form-control" required>
					</div>
					<div class="col-sm">
